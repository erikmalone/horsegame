package 
{
	 ...
	 * @author E
	 */
	public class butt5 extends Sprite 
	{
		...
		public function butt5(_str:String) { str = _str;
			if (stage) init();
		...
		private function showContinue():void {
			...
			con.graphics.beginGradientFill("linear", new Array(921102,0x00ff00),new Array(1,1),new Array(0,255),matrix,"reflect","linear_rgb",0);
